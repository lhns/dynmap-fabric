...
//    		    }
    ...
    private Object getNBTValue(Tag v) {
        ...
        switch (v.getType()) {
            case 1: // Byte
                val = ((ByteTag) v).getByte();
                break;
            case 2: // Short
                val = ((ShortTag) v).getShort();
                break;
            case 3: // Int
                val = ((IntTag) v).getInt();
                break;
            case 4: // Long
                val = ((LongTag) v).getLong();
                break;
            case 5: // Float
                val = ((FloatTag) v).getFloat();
                break;
            case 6: // Double
                val = ((DoubleTag) v).getDouble();
                break;
            case 7: // Byte[]
                val = ((ByteArrayTag) v).getByteArray();
                break;
            case 8: // String
                val = ((StringTag) v).asString();
                break;
            case 9: // List
                ListTag tl = (ListTag) v;
                ArrayList<Object> vlist = new ArrayList<Object>();
                int type = tl.getElementType();
    ...
    private SnapshotCache.SnapshotRec prepChunkSnapshot(DynmapChunk chunk, CompoundTag nbt) {
        ...
        if (tiles == null) tiles = new ListTag();
